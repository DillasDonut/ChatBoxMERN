    ...
    return (
        ...
        <div className="app" style={{ background: '#344354'}}>
            ...
            <div className="btndiv">
                <Link to="/register"><Button  size='large' type="primary">
                    <span style={{color:'#61E58E'}}>Register</span>
                    </Button>
                </Link> <Link to="/login"><Button size='large' type="primary" ><span style={{color:'#61E58E'}}>Log in</span></Button></Link>
